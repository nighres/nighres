...
def laminar_iterative_smoothing(profile_surface_image, data_image, fwhm_mm,
    ...
    intensity_img = load_volume(data_image)
    ...
    smoother.setDimensions(dimensions[0], dimensions[1], 
