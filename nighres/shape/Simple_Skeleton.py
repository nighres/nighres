...
def Simple_Skeleton(input_image,
   ...
   Medial_Curve_Image
    ...
    d_head['cal_max'] = np.nanmax(medialImage_data)
    medialImage = nb.Nifti1Image(medialImage_data, affine, header=d_head, data_type='int8')

    header['cal_max'] = np.nanmax(skelImage_data)
    skelImage = nb.Nifti1Image(skelImage_data, affine, header=d_head, data_type='int8')
