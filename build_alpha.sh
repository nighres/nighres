...
echo "${pip_modules}" | grep JCC > /dev/null || fatal 'This script requires JCC 3.0.\nInstall with `python3 -m pip install jcc`'
...
jar cf ../nighresjava/src/nighresjava.jar ca/concordia/qpi/*/*.class de/mpg/cbs/core/*/*.class
